...
<div class="page-heading">
    ...
    <section class="section">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('orangtua.pemberkasan.store', $pemberkasan->id) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-body py-2">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea
                                ...
                                style="border-radius: 8px; border-color: #dfe3e7;">{{ old('jawaban') }}</textarea>
                            @error('jawaban')
                        ...
                        <div class="form-group mt-5">
                            <div class="d-flex">
                                ...
                                <a href="{{ url()->previous() }}" class="btn btn-light-secondary ms-2">
